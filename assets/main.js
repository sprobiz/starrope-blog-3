document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- CLIENT-SIDE POST REAL-TIME SEARCH (KOREAN OPTIMIZED) ---
      ...
      if (visibleCards.length === 0) {
        if (!noResultsMsg) {
          ...
          noResultsMsg.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" style="width: 48px; height: 48px; margin: 0 auto 16px auto; display: block; opacity: 0.5; color: var(--primary-color);" fill="none" viewBox="0 0 24 24" stroke="currentColor">
